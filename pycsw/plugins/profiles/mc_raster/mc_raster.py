            ...
            typename: TypenameModel(
                added_namespaces[prefix],
                {
                    'MCRasterQueryables': {
                        ...
                        'mc:minResolutionDeg': Queryable(context.md_core_model['mappings']['pycsw:minResolutionDeg'], 'mc:minResolutionDeg'),
                        ...
                        'mc:maxHorizontalAccuracyCE90': Queryable(context.md_core_model['mappings']['pycsw:maxHorizontalAccuracyCE90'], 'mc:maxHorizontalAccuracyCE90'),
